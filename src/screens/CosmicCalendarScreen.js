...
const EVENTS = [
  ...
  { title: 'Huroni eljegesedés', mya: 2400.0, desc: 'A Föld egyik legkorábbi globális eljegesedése — nagyjából a légkör feloxigénesedésével egy időben.' },
  ...
  { title: 'Rodinia szuperkontinens', mya: 1000.0, desc: 'A kontinensek a Rodinia nevű szuperkontinenssé álltak össze.' },
  { title: 'Sturti hógolyó-Föld', mya: 717.0, desc: 'A jég a trópusokig ért; a Föld szinte teljesen befagyott.' },
  { title: 'Marinói hógolyó-Föld', mya: 650.0, desc: 'A második nagy globális eljegesedés a kriogén időszakban.' },
  { title: 'Pannotia szuperkontinens', mya: 600.0, desc: 'Rövid életű szuperkontinens a prekambrium legvégén.' },
  ...
  { title: 'Pangea kialakulása', mya: 335.0, desc: 'A szárazföldek egyetlen óriási szuperkontinenssé olvadtak össze.' },
  ...
  { title: 'Oxigéncsúcs a karbonban', mya: 300.0, desc: 'A légköri oxigénszint a mai fölé emelkedik — ekkor élnek az óriás ízeltlábúak.' },
  ...
  { title: 'Pangea felbomlása', mya: 175.0, desc: 'A szuperkontinens darabokra kezd szakadni; nyílni kezd az Atlanti-óceán.' },
  ...
  { title: 'Toba szupervulkán', mya: 0.074, desc: 'Az elmúlt évmilliók egyik legnagyobb vulkánkitörése (Szumátra).' },
  { title: 'Kivándorlás Afrikából', mya: 0.07, desc: 'A modern emberek nagyobb hullámban elterjednek Afrikán kívül.' },
  { title: 'Utolsó glaciális maximum', mya: 0.021, desc: 'A legutóbbi jégkorszak tetőpontja; kiterjedt jégtakarók.' },
